...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'token', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Data.Problem.Problem":{"args":[],"type":"{ url : String.String, answer : String.String }"},"Data.Variant.Variant":{"args":[],"type":"{ id : Data.Variant.VariantId, timeLeft : Basics.Int, done : Basics.Bool, problems : List.List Data.Problem.Problem }"},"Data.Variant.VariantId":{"args":[],"type":"String.String"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Bootstrap.Navbar.VisibilityState":{"args":[],"type":"{ visibility : Bootstrap.Navbar.Visibility, height : Maybe.Maybe Basics.Float, windowWidth : Maybe.Maybe Basics.Float, dropdowns : Dict.Dict String.String Bootstrap.Navbar.DropdownStatus }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"VariantMsg":["View.Variant.Msg"],"NavbarMsg":["Bootstrap.Navbar.State"]}},"View.Variant.Msg":{"args":[],"tags":{"LostFocus":[],"InputAnswer":["Basics.Int","String.String"],"GetVariant":["RemoteData.WebData Data.Variant.Variant"],"UpdatedVariant":["RemoteData.WebData ()"],"CommitVariant":[],"CommitedVariant":["RemoteData.WebData ()"],"Tick":["Time.Posix"],"CloseModal":[]}},"Bootstrap.Navbar.State":{"args":[],"tags":{"State":["Bootstrap.Navbar.VisibilityState"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"Bootstrap.Navbar.DropdownStatus":{"args":[],"tags":{"Open":[],"ListenClicks":[],"Closed":[]}},"Bootstrap.Navbar.Visibility":{"args":[],"tags":{"Hidden":[],"StartDown":[],"AnimatingDown":[],"StartUp":[],"AnimatingUp":[],"Shown":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));